...
- [ ] 03-08-PLAN.md — Buyer UI shared components: GatewaySelector, KeyRevealBox, OrderStatusBadge, DeliveryTimeline, ConfirmReceiptDialog (Wave 5)
- [ ] 03-09-PLAN.md — Seller UI: dashboard Orders tab + DeliverCredentialsModal (Wave 5)
- [ ] 03-10-PLAN.md — Buyer UI pages: checkout + order history + order detail (Wave 5, depends on 03-08)
**UI hint**: yes
